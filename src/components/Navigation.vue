<template>
  <header v-bind:class="{ header: toggle }">
    <nav class="navbar">
      ...
      <div class="navbar__list" v-bind:class="{ navbar__list_toggle: toggle }">
        <svg v-if="toggle"
        ...
        <router-link class="navbar__link" to="/">shop</router-link>
        <router-link class="navbar__link" to="/">about</router-link>
        <router-link class="navbar__link" to="/">contact</router-link>
      </div>
    </nav>
  </header>
</template>
